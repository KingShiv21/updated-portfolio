...
const ProjectItem = ({image,name,about,git_link,deployment_link}) => {
  return (
    <div className='mx-5 sm:w-1/4 sm:mx-5 my-5  text-center bg-gray-200 sm:bg-white py-3 sm:shadow-2xl'>
     <a href={deployment_link} target='_blank'> <img src={image} alt="Image not found" className=' w-48 h-48 mx-auto'/></a>
      <h1 className=' font-bold text-2xl'>{name}</h1>
      <a  href={git_link} target='_blank'><GitHubIcon fontSize='large'/></a>
